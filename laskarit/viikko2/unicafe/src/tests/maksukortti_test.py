...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_metodi_palauttaa_true_jos_rahaa_tarpeeksi(self):
        self.assertEqual(self.maksukortti.ota_rahaa(500), True)

    def test_metodi_palauttaa_false_jos_rahaa_ei_tarpeeksi(self):
        self.assertEqual(self.maksukortti.ota_rahaa(1500), False)

    def test_merkkijonometodi_toimii_oikein(self):
